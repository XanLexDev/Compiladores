...
{
  "\"end of file\"", "error", "\"invalid token\"", "BOOLEAN", "OR", "AND",
...
{
       2,     3,     8,     4,     9,    10,     5,    12,     6,     4,
      15,    16,     5,     0,     6,    11,    12,     0,    11,    12,
      14,    13
};
